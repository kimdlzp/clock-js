...
const initArray = (length, f = (_, i) => i) =>
  Array.from({ length: length }, f);
const fontLink = createElement("link", {
  rel: "stylesheet",
  href: FONT_FAMILY_EMBED,
});
const loop = () => {
  const set = new Set();
